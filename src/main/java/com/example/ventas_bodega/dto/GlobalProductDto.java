...
// Producto visto desde Mantenimiento > Productos generales (SUPER_ADMIN):
// el catálogo compartido (tb_producto_general) que alimenta la búsqueda por
// código de barras al crear un producto en cualquier empresa.
